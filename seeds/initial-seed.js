...
const chargeTypeData = require('./data/charge_type');
...
exports.seed = function (knex, Promise) {
  return knex('order').del()
    ...
    .then(() => knex('charge_type').insert(chargeTypeData))
    .then(() => knex.raw("SELECT setval('charge_type_id_seq', (SELECT COUNT(*) FROM charge_type))"))
