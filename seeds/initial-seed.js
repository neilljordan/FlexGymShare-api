...
const passData = require('./data/pass');
...
const gymStaffData = require('./data/gym_staff');
...
exports.seed = function (knex, Promise) {
  return knex('order').del()
    ...
    .then(() => knex('gym_staff').insert(gymStaffData))
    .then(() => knex.raw("SELECT setval('gym_staff_id_seq', (SELECT COUNT(*) FROM gym_staff))"))
    ...
    .then(() => knex('pass').insert(passData))
    .then(() => knex.raw("SELECT setval('pass_id_seq', (SELECT COUNT(*) FROM pass))"))
