module.exports = [
  {
    gym_id: 1,
    name: 'schedule_link',
    value: 'http://oneboulderfitness.com/schedule',
  },
  {
    gym_id: 1,
    name: 'facebook_handle',
    value: 'oneboulderfitness',
  },
  {
    gym_id: 1,
    name: 'default_price',
  ...
  },
  {
    gym_id: 1,
    name: 'description',
    value: 'One Rock Climbing offers you a cutting-edge Conditioning Center, innovative Group Training and the area’s finest, friendliest Professional Fitness Trainers.  We’re located in the heart of downtown Boulder, with free parking included. Experience the convenience, effectiveness and energy of an OBF workout.',
  },
  {
    gym_id: 2,
    name: 'schedule_link',
    value: 'http://www.crossfitsanitas.com/classes/',
  },
  {
    gym_id: 2,
    name: 'facebook_handle',
    value: 'CrossFitSanitas',
  },
  {
    gym_id: 2,
    name: 'default_price',
